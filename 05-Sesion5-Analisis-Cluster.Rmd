...
```{r, collapse=TRUE,prompt=FALSE, warning=FALSE,message=FALSE}
...
```{r, collapse=TRUE,prompt=TRUE, warning=FALSE,message=FALSE}
library(dplyr)
library(magrittr)
library(plyr)
library(ggplot2)
...
```{r, collapse=TRUE,prompt=TRUE, Warnings=FALSE}
