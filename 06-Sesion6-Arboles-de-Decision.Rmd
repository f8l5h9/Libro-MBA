...
```{r myfirsttree, fig.width = 8, fig.height = 4.5, fig.cap="\\label{fig:myfirsttree}Árbol de regresión"}
...
```{r, fig.cap="\\label{fig:particion0}Partición del espacio con predicciones", fig.width = 5, fig.height = 4}
...
```{r, fig.width = 8, fig.height = 6, fig.cap="\\label{fig:arbol1}Árbol base."}
rpart.plot(arbol_1)
```
...
```{r, fig.width = 3.5, fig.height = 3.5, fig.cap="\\label{fig:arbol2}Árbol base 2."}
library(rpart.plot)
...
```{r, fig.width = 2.5, fig.height = 2.5, fig.cap="\\label{fig:arbol3}Árbol base 3."}
library(rpart.plot)
...
```{r, fig.width = 3.5, fig.height = 3.5, fig.cap="\\label{fig:arbol4}Árbol base 4."}
...
```{r, warning=FALSE, fig.cap="\\label{fig:particion}Partición del espacio con predicciones", fig.width = 7, fig.height = 3}
library(gridExtra)
library(ggplot2)
